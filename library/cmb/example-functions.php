 ...
 *
 * Be sure to replace all instances of 'crane_hse_' with your project's prefix.
...
add_action( 'cmb2_init', 'crane_hse_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_init' hook.
 */
function crane_hse_register_demo_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_crane_hse_demo_';
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'crane_hse_before_row_if_2', // callback
...
add_action( 'cmb2_init', 'crane_hse_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function crane_hse_register_about_page_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_crane_hse_about_';
...
add_action( 'cmb2_init', 'crane_hse_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function crane_hse_register_repeatable_group_field_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_crane_hse_group_';
...
add_action( 'cmb2_init', 'crane_hse_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function crane_hse_register_user_profile_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_crane_hse_user_';
...
add_action( 'cmb2_init', 'crane_hse_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function crane_hse_register_theme_options_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$option_key = '_crane_hse_theme_options';
