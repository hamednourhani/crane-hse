window.site_logo = theme_info.theme_dir+"/images/crane_hse-logo.png";
console.log(site_logo);
window.loading_screen = window.pleaseWait({

		        //logo: theme_info.theme_dir+"/images/crane_hse-logo.png",
		        //console.log(site_logo);
		        logo:site_logo,

		        logo: "wp-content/themes/crane_hse.com/images/crane_hse-logo.png",
